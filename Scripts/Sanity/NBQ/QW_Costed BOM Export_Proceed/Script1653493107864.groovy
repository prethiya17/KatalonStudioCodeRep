...
WebUI.click(findTestObject('Object Repository/Page_PIR/button_QWProject_qw-caret'))

WebUI.click(findTestObject('Object Repository/Page_PIR/a_Restore your last saved QW project'))
...
WebUI.click(findTestObject('Object Repository/Page_PIR/button_Proceed'))
