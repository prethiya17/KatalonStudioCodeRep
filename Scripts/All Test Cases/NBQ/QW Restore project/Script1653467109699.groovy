...
WebUI.click(findTestObject('Page_Price It Right/button_Export'))

WebUI.scrollToElement(findTestObject('Page_PIR/Page_PIR_NBQ/a_Costed BOM Report'), 0)

WebUI.click(findTestObject('Page_PIR/Page_PIR_NBQ/a_Costed BOM Report'))
