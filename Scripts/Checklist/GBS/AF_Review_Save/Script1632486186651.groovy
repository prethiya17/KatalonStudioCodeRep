...
WebUI.verifyElementPresent(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/div_Commodity code'), 2)

WebUI.setText(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/input_Commodity Prefix_attr'), 'CAP')
