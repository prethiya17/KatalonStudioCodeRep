...
WebUI.click(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_Mainpage/button_MPNoptionsReview'))

WebUI.click(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/button_Revert'))

WebUI.verifyElementPresent(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/div_WARNING_Revert'), 2)

WebUI.click(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/button_Yes'))

WebUI.click(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_Mainpage/button_MPNoptionsReview'))

WebUI.click(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/button_Save'))

WebUI.delay(2)

WebUI.verifyElementPresent(findTestObject('Page_DIR_GBS/GBS Project/Alternate Finder/AF_ReviewPage/div_Save Success'), 2)
